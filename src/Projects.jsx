...
function Projects(){
    const quotingToolInfo = {
        ...
        desc: (
            ...
            A key functionality included the ability to generate professional-grade <a href="/portfolio-website/Software_Resume.pdf" download="Quoting Tool Example PDF" title="Example PDF">PDFs</a> of quotes using html2canvas and jsPDF, ensuring consistent formatting and simplifying document management.
            </>
        ),
    };
